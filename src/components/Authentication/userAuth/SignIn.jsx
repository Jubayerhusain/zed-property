...
const SignIn = () => {
  return (
    <div className="w-full  mx-auto">
      <div className=" shadow-xl sm:w-9/12 rounded-2xl flex my-10  mx-auto ">
        <div className="w-full  sm:w-4/8 sm:rounded-l-2xl ">
          <img
        ...
        <div className=" w-full sm:w-4/8 p-24 rounded-r-2xl bg-white ">
          ...
          <div className=" pt-5 mx-auto grid grid-cols-1 justify-center ">
            ...
            <h1 className=" text-center font-semibold text-sm gap-1 pt-5">
              ...
              <NavLink to={""} className="text-green-400 pl-1">Register now</NavLink>
            </h1>
          </div>
        </div>
      </div>
