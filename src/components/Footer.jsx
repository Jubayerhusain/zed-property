...
const Footer = () => {
  const footerSections = [
    {
      title: "Company",
      links: ["About Us", "Blog", "Property", "Contact"],
    },
    {
      title: "Social Media",
    ...
    {
      title: "Services",
      links: ["Buy Property", "Sell Property", "Property Agent"],
    },
    {
      title: "Contact",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                href="#"
                className="w-9 h-9 rounded-full bg-gray-200 hover:bg-green-500 flex items-center justify-center transition-colors duration-200 group"
              >
                <svg
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {section.links.map((link, linkIndex) => (
                      <li key={linkIndex}>
                        <a
                          href="#"
                          className="text-sm sm:text-base text-gray-600 hover:text-green-600 transition-colors duration-200 inline-block"
                        >
                          {link}
                        </a>
                      </li>
        ...
        <div className="mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              <a
                href="#"
                className="text-sm sm:text-base text-gray-600 hover:text-green-600 transition-colors duration-200"
              >
                Privacy Policy
              </a>
              <a
